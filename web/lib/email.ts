    ...
    <tr><td align="center">
      <table width="560" cellpadding="0" cellspacing="0" style="background:#111;border:1px solid #222;border-radius:12px;overflow:hidden;">
        ...
        <tr><td style="padding:0 40px 32px;text-align:center;">
          <a href="https://c13studios.com/downloads/HL.Signalbot_1.0.5_universal.dmg" style="display:inline-block;background:#ff6b00;color:#000;font-weight:700;font-size:14px;padding:12px 24px;border-radius:999px;text-decoration:none;margin:0 6px 8px;">Download for Mac</a>
          <a href="https://c13studios.com/downloads/HL.Signalbot_1.0.5_x64-setup.exe" style="display:inline-block;background:#333;color:#fff;font-weight:700;font-size:14px;padding:12px 24px;border-radius:999px;text-decoration:none;margin:0 6px 8px;">Download for Windows</a>
        </td></tr>
